...
The core objective of this project is to model the relationship between satellite-derived environmental features and future dengue cases, and to analyze how different deep learning architectures affect prediction accuracy.
...
Multiple spectral bands are used to capture diverse environmental characteristics.

Satellite images are processed on a monthly basis to align with dengue case records.

Dengue Case Data

Monthly dengue case counts for selected cities.

The dengue case data is included directly in the repository.

Each data point corresponds to a specific city and month.

Dataset Access

The processed satellite dataset used in this project is hosted on Google Drive:

https://drive.google.com/drive/folders/1GtCrOjzrWqbyT1iQBMrAbCWJ7XRgcgwE


Note: The repository already contains the dengue case CSV files and all result visualizations.
...
A fixed multi-month window is used to model delayed environmental effects on dengue outbreaks.
...
Download the satellite dataset from the Google Drive link and place it in the appropriate data directory.
...
Kuo, K.-T., Ong, S. P., & Wong, M. C., DengueNet: Dengue Prediction using Spatiotemporal Satellite Imagery, 2020.

Li, Y., & Dong, S., Big Geospatial Data and Data-Driven Methods for Urban Dengue Risk Forecasting, 2022.
